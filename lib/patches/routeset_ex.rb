...
#     map.theme_images "/themes/:site/:theme/images/*filename", :controller=>'theme', :action=>'images'
#     map.theme_stylesheets "/themes/:site/:theme/stylesheets/*filename", :controller=>'theme', :action=>'stylesheets'
#     map.theme_javascript "/themes/:site/:theme/javascript/*filename", :controller=>'theme', :action=>'javascript'
